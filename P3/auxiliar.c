...
t_command commands[] =
    {
        ...
        {"erase", cmd_erase, SHORT_HELP_ERASE, LONG_HELP_ERASE},
        {"delrec", cmd_delrec, SHORT_HELP_DELREC, LONG_HELP_DELREC},
        {"lseek", cmd_lseek, SHORT_HELP_LSEEK, LONG_HELP_LSEEK},
        {"writestr", cmd_writestr, SHORT_HELP_WRITESTR, LONG_HELP_WRITESTR},
        {"malloc", cmd_malloc, SHORT_HELP_MALLOC, LONG_HELP_MALLOC},
        {"mmap", cmd_mmap, SHORT_HELP_MMAP, LONG_HELP_MMAP},
        {"shared", cmd_shared, SHORT_HELP_SHARED, LONG_HELP_SHARED},
        {"free", cmd_free, SHORT_HELP_FREE, LONG_HELP_FREE},
        {"memfill", cmd_memfill, SHORT_HELP_MEMFILL, LONG_HELP_MEMFILL},
        {"memdump", cmd_memdump, SHORT_HELP_MEMDUMP, LONG_HELP_MEMDUMP},
        {"mem", cmd_mem, SHORT_HELP_MEM, LONG_HELP_MEM},
        {"readfile", cmd_readfile, SHORT_HELP_READFILE, LONG_HELP_READFILE},
        {"writefile", cmd_writefile, SHORT_HELP_WRITEFILE, LONG_HELP_WRITEFILE},
